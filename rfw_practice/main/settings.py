"""
Django settings for rfw_practice project.
...
SECRET_KEY = 'w(t_om5(33pjls-4#y$sytr$rl3ympy^ez534v8td(r(g@jt*c'
...
DTABASE_PASSWORD =  os.getenv('PASSWORD')
...
from .global_permit_auth import *